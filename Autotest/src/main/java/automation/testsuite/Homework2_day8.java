...
public class Homework2_day8 extends CommonBase {
	...
	public void idElement() {
		...
		System.out.println("Address Id Element is: "+ addressId);
		WebElement emailId = driver.findElement(By.id("email"));
		System.out.println("Email Id Element is: "+ emailId);
	...
	public void nameElement() {
		...
		System.out.println("Address Name Element is: "+ addressName);
		WebElement emailName = driver.findElement(By.name("email"));
		System.out.println("Email Name Element is: "+ emailName);
	...
	public void tagNameElement() {
		...
		System.out.println("Textarea Element is: "+ textareaTagName);
	}
